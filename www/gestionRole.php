...
<html lang="fr">
    ...
    <?php
                ...
                <form method="POST" action="gestionRole.php">
                    <div class="row pl-3 pr-3">
                        <div class="input-group col-3">
                            <input type="text" class="form-control" placeholder="Username" name="nameSearch"  style="height: 20px;">
                            <div class="input-group-append">
                                <input class="input-group-text" type="submit" value="Rechercher !"  style="height: 20px;">
                            </div>
                        </div>
        ...
        if (isset($_POST['nameSearch']) && ctype_alnum($_POST['nameSearch'])) {
            //Display users
            $prepared = $bdd->prepare("SELECT id, username, role FROM membres WHERE username LIKE :nameSearch");
            $values = array(':nameSearch' => "%$_POST[nameSearch]%");
                    ...
                    echo '
                                    <li class="list-group-item border-0">
                                        <div class="input-group">
                                            ...
                                            <p class="form-control text-capitalize" style="height: 20px;">' . $row['username'] . '</p>
                                            <div class="input-group-append">
                                                <div class="input-group-text" style="height: 20px;">
                                                    <p>' . $row['role'] . '</p>
                                                </div>
                            ...
                            <div class="col-8">
                                ...
                                <div class="row pt-3">
                                    <div class="input-group mb-3 col-3">
                                        ...
                                        <p class="form-control" style="height: 20px;"> Visiteur </p>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="input-group mb-3 col-3">
                                        ...
                                        <p class="form-control" style="height: 20px;"> Contributeur </p>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="input-group mb-3 col-3">
                                        ...
                                        <p class="form-control" style="height: 20px;"> Admin </p>
                                    </div>
                                </div>
