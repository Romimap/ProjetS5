<!-- PAGE TEMPLATE -->
<?php
$WWWPATH = "/opt/lampp/htdocs/www/21-10/";
...
<html lang="fr">
	...
	<link rel="stylesheet" type="text/css" href="stylespc.css" media="screen" />
    <!-- Required meta tags -->
    <meta charset="utf-8">
            ...
            <div class="container">
              <div class="row">
                <div class="col-md-9 col-lg-8 mx-auto">
                  ...
                  <form method="post" action="./template/connectionCompte.php">
